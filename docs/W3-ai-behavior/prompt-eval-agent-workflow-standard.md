...
本文件是 W3 AI Behavior 的触发型专项规范，不是 W3 主入口。只有当 `docs/W3-ai-behavior/main.md` 已经判断需要更细地定义 prompt、eval、结构化输出、workflow/agent 升级或最小 AI 质量门禁时，才读取本文件。

如果当前只是判断 AI 行为应该先读哪个文件，或只需要定义好坏样本、安全边界和出口，先回到 `docs/W3-ai-behavior/main.md`。
