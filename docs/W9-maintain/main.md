...
- 新工作优先级，回到 `docs/W0-intake/main.md`。
- 产品学习、支持反馈或 AI 质量回归，回到 `docs/W8-learn/main.md`。
- 运行事故、凭据、恢复和生产操作，回到 `docs/W7-operate/main.md`。
- 发布、客户上线、对外声明和合同承诺，回到 `docs/W6-release/main.md`。
...
- 更新后的 canonical 入口：README、`docs/00-start-here.md`、`docs/00-standard-index.md`、docs map 或 context pack 中适用项。
...
- 文档入口、context pack、docs map、glossary、how-to、freshness、Codex handoff：`docs/W9-maintain/knowledge-context-recovery-standard.md`
- 依赖升级、技术债、弃用、runtime/framework/AI SDK 维护、Dependabot、deprecation：`docs/W9-maintain/maintenance-dependency-debt-standard.md`
- 审计证据、证据包、audit log、retention、customer/security evidence、SOC 2 readiness：`docs/W9-maintain/audit-evidence-compliance-standard.md`
- 开源仓库、SDK/CLI/template、community health、贡献策略、security advisory、公开维护边界：`docs/W9-maintain/open-source-release-community-maintenance-standard.md`
...
- 当前 W9 目录只有一个 `main.md` 作为核心入口。
- 所有其它 W9 文件都是触发型专项，并在开头说明不是主入口。
- 入口、索引和 source map 都指向 `docs/W9-maintain/main.md` 与语义化专项文件名。
