...
- “要不要做”和优先级判断，回到 `docs/W0-intake/main.md`。
- 用户问题、成功指标、实验设计，回到 `docs/W1-discovery/main.md`。
- OpenSpec、架构、契约、安全、成本、权限、供应商和信任边界，回到 `docs/W2-openspec-risk/main.md`。
- AI 行为定义、eval、红队、模型路由、工具权限、RAG 来源和记忆策略，回到 `docs/W3-ai-behavior/main.md`。
...
- Go/Kratos/sqlc/gRPC 服务、proto、repository、service 层或后端质量门禁：`docs/W4-build/go-kratos-sqlc-grpc-service-standard.md`
- Vite、React/TypeScript、前端状态、设计 token、可访问交互或 preview：`docs/W4-build/vite-vercel-frontend-standard.md`
- schema、migration、sqlc、backfill、数据修复、备份/恢复前置检查：`docs/W4-build/data-migration-standard.md`
- 配置、环境变量、Feature Flag、kill switch、AI route/runtime change：`docs/W4-build/configuration-feature-flag-standard.md`
- 本地命令、工具链、devcontainer/compose、seed fixtures、one-step verify：`docs/W4-build/dev-workspace-automation-standard.md`
- AI 协作编码、变更批次、自审、verification JSON、agent stop condition：`docs/W4-build/ai-coding-workflow-standard.md`
- 付费、套餐、权益、用量计量、Stripe、账本、对账：`docs/W4-build/billing-entitlement-metering-standard.md`
- 异步 job、worker、队列、Batch/background、取消、重试、死信：`docs/W4-build/async-job-worker-standard.md`
- 入站 webhook、出站事件、inbox/outbox、验签、重放和集成 schema：`docs/W4-build/event-webhook-integration-standard.md`
- 邮件、SMS、push、通知模板、退订、偏好、送达事件：`docs/W4-build/user-notification-messaging-standard.md`
- 对外 API 文档、SDK、示例、developer changelog、文档站：`docs/W4-build/developer-experience-api-docs-sdk-standard.md`
