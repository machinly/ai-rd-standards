...
Define the minimum one-person-company governance for AI memory, user preferences, long-term context, RAG sources, context injection, user controls, deletion/export, and memory review.
