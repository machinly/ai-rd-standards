...
Define the minimum one-person-company governance for RAG knowledge sources, ingestion, chunking, embedding, indexing, retrieval filters, citation/grounding, poisoning controls, deletion/reindex, and RAG eval review across Go/Kratos/sqlc/gRPC services, Vite surfaces, and AI workflows.
