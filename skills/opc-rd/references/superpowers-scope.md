...
Apply the R&D applicability gate first. Non-R&D work does not invoke `opc-rd` and does not invoke Superpowers unless that task has a concrete complex problem directly served by one specific skill.
